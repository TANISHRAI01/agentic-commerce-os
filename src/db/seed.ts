...
const MERCHANTS: SeedMerchant[] = [
  { id: 'merch-001', name: 'SoundWave Electronics', trustTier: 'PLATINUM', description: 'Premium audio and electronics retailer with 15+ years of excellence.' },
  { id: 'merch-002', name: 'TechBazaar India', trustTier: 'GOLD', description: 'Trusted marketplace for tech gadgets and accessories.' },
  { id: 'merch-003', name: 'GadgetZone', trustTier: 'SILVER', description: 'Affordable electronics and gadgets for everyday use.' },
  { id: 'merch-004', name: 'HomeComfort Plus', trustTier: 'GOLD', description: 'Home appliances and comfort products specialist.' },
  { id: 'merch-005', name: 'BookHaven', trustTier: 'PLATINUM', description: 'India\'s largest online bookstore with fast delivery.' },
  { id: 'merch-006', name: 'FitLife Store', trustTier: 'BRONZE', description: 'Fitness equipment and sports accessories.' },
];
...
const PRODUCTS: SeedProduct[] = [
  ...
  { id: 'prod-053', merchantId: 'merch-002', name: 'Samsung T7 1TB Portable SSD', description: '1TB portable SSD with USB 3.2. Transfer speeds up to 1050 MB/s. Compact and durable.', category: 'accessories', price: 7999, stock: 25, rating: 4.6, deliveryDays: 2, attributes: { brand: 'Samsung', type: 'portable-ssd', capacity: '1TB', speed: '1050 MB/s' }, tags: ['storage', 'ssd', 'portable', 'fast', 'samsung'] },
  ...
  { id: 'prod-056', merchantId: 'merch-001', name: 'Logitech MX Master 3S', description: 'Advanced wireless mouse with 8K DPI sensor. Quiet clicks and MagSpeed scroll wheel.', category: 'accessories', price: 8495, stock: 15, rating: 4.8, deliveryDays: 2, attributes: { brand: 'Logitech', type: 'mouse', connectivity: 'bluetooth', dpi: '8000' }, tags: ['mouse', 'wireless', 'premium', 'ergonomic', 'productivity'] },
  { id: 'prod-057', merchantId: 'merch-002', name: 'Ambrane 65W GaN Charger', description: '65W GaN charger with USB-C PD and USB-A ports. Compact and travel-friendly.', category: 'accessories', price: 1799, stock: 70, rating: 4.3, deliveryDays: 2, attributes: { brand: 'Ambrane', type: 'charger', power: '65W', technology: 'GaN' }, tags: ['charger', 'fast-charge', 'usb-c', 'gan', 'compact'] },
  { id: 'prod-058', merchantId: 'merch-003', name: 'Croma USB-C Hub 7-in-1', description: '7-in-1 USB-C hub with HDMI, USB 3.0, SD card reader, and PD charging passthrough.', category: 'accessories', price: 1999, stock: 45, rating: 4.1, deliveryDays: 3, attributes: { brand: 'Croma', type: 'usb-hub', ports: '7', features: 'HDMI,USB3,SD' }, tags: ['hub', 'usb-c', 'dock', 'hdmi', 'adapter'] },
  { id: 'prod-059', merchantId: 'merch-001', name: 'Keychron K2 V2 Mechanical Keyboard', description: '75% wireless mechanical keyboard with Gateron switches. Bluetooth + USB-C. RGB backlight.', category: 'accessories', price: 6999, stock: 10, rating: 4.6, deliveryDays: 4, attributes: { brand: 'Keychron', type: 'keyboard', layout: '75%', switches: 'Gateron', connectivity: 'bluetooth' }, tags: ['keyboard', 'mechanical', 'wireless', 'rgb', 'premium'] },
  { id: 'prod-060', merchantId: 'merch-002', name: 'boAt Watch Xtend Plus', description: '1.78" AMOLED smartwatch with Bluetooth calling, SpO2, and 100+ sports modes.', category: 'accessories', price: 2499, stock: 55, rating: 4.0, deliveryDays: 2, attributes: { brand: 'boAt', type: 'smartwatch', display: '1.78" AMOLED' }, tags: ['smartwatch', 'calling', 'amoled', 'sports', 'affordable'] },
];
...
export function seedDatabase(db: SqlJsDatabase): { merchants: number; products: number } {
  ...
  for (const m of MERCHANTS) {
    db.run(
      `INSERT INTO merchants (id, name, trust_tier, description) VALUES (?, ?, ?, ?)`,
      [m.id, m.name, m.trustTier, m.description],
    );
  }
  ...
  for (const p of PRODUCTS) {
    ...
    db.run(
      `INSERT INTO products (id, merchant_id, name, description, category, price, currency, stock, rating, delivery_days, merchant_trust_tier, attributes, tags)
       VALUES (?, ?, ?, ?, ?, ?, 'INR', ?, ?, ?, ?, ?, ?)`,
      [
